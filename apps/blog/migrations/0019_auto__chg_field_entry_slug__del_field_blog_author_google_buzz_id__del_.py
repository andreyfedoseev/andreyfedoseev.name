...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blog_entry', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from='title'))
        # Deleting field 'Blog.author_google_buzz_id'
        db.delete_column('blog_blog', 'author_google_buzz_id')

        # Deleting field 'Comment.google_buzz_id'
        db.delete_column('blog_comment', 'google_buzz_id')


    def backwards(self, orm):

        # Changing field 'Entry.slug'
        db.alter_column('blog_entry', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=(), populate_from=None))
        # Adding field 'Blog.author_google_buzz_id'
        db.add_column('blog_blog', 'author_google_buzz_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Comment.google_buzz_id'
        db.add_column('blog_comment', 'google_buzz_id',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'blog.comment': {
            ...
            'author_email': ('django.db.models.fields.EmailField', [], {'default': "u''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'author_name': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'author_url': ('django.db.models.fields.URLField', [], {'default': "u''", 'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'idQyd'", 'max_length': '5', 'null': 'True', 'blank': 'True'}),
        ...
        'blog.entry': {
            ...
            'markdown': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

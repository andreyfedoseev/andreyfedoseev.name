...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_blog', 'language', self.gf('django.db.models.fields.CharField')(default='ru', unique=True, max_length=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Blog.language'
        db.delete_column('blog_blog', 'language')

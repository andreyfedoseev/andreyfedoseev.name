...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('blog_entry', 'entry_type')


    def backwards(self, orm):
        
        # Adding field 'Entry.entry_type'
        db.add_column('blog_entry', 'entry_type', self.gf('django.db.models.fields.CharField')(default='text', max_length=20), keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.is_spam'
        db.add_column('blog_comment', 'is_spam', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.is_spam'
        db.delete_column('blog_comment', 'is_spam')
    ...
    models = {
        ...
        'blog.comment': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'zU6K8'", 'max_length': '5', 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Blog.site'
        db.delete_column('blog_blog', 'site_id')


    def backwards(self, orm):
        
        # Adding field 'Blog.site'
        db.add_column('blog_blog', 'site', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['sites.Site'], unique=True), keep_default=False)

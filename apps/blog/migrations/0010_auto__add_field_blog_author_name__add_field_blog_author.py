...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Blog.author_name'
        db.add_column('blog_blog', 'author_name', self.gf('django.db.models.fields.CharField')(default=u'', max_length=100), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Blog.author_name'
        db.delete_column('blog_blog', 'author_name')

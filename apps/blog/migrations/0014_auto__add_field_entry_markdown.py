...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.markdown'
        db.add_column('blog_entry', 'markdown', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.markdown'
        db.delete_column('blog_entry', 'markdown')

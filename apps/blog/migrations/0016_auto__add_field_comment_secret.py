...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Comment.secret'
        db.add_column('blog_comment', 'secret', self.gf('django.db.models.fields.CharField')(default='oTSup', max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.secret'
        db.delete_column('blog_comment', 'secret')
    ...
    models = {
        ...
        'blog.comment': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'coNTd'", 'max_length': '5', 'null': 'True', 'blank': 'True'}),

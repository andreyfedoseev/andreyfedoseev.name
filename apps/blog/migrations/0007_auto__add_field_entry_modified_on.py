...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_entry', 'modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 6, 21, 23, 23, 31, 942921), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.modified_on'
        db.delete_column('blog_entry', 'modified_on')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Blog.feed_url'
        db.add_column('blog_blog', 'feed_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Blog.feed_url'
        db.delete_column('blog_blog', 'feed_url')

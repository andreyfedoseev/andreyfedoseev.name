...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.author_name'
        db.alter_column('blog_comment', 'author_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Comment.author_name'
        raise RuntimeError("Cannot reverse this migration. 'Comment.author_name' and its values cannot be restored.")

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_comment', (
            ...
            ('entry', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['blog.Entry'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['blog.Comment'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='blog_comments', null=True, to=orm['auth.User'])),
            ('author_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('author_email', self.gf('django.db.models.fields.EmailField')(max_length=100, null=True, blank=True)),

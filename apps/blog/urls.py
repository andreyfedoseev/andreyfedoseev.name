...
urlpatterns = patterns('',
    ...
    url(r'^tags/$', 'blog.views.by_tag', name="by_tag"),
    url(r'^tags/(?P<tag>[^/]+)/(?:page/(?P<page>\d+)/)?$', 'blog.views.index_by_tag', name="index_by_tag"),
    url(r'^switch-display-type$', 'blog.views.switch_display_type', name="switch_display_type"),

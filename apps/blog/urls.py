...
urlpatterns = patterns('blog.views',
    ...
    # Admin
    url(r'^admin/$', permission_required("add_entry")(Index.as_view()), name="admin-index"),
    url(r'^admin/preview/$', permission_required("add_entry")(EntryPreview.as_view()), name="preview"),
    url(r'^admin/new/$', permission_required("add_entry")(AddEntry.as_view()), name="add-entry"),
    url(r'^admin/edit/(?P<pk>\d+)/$', permission_required("edit_entry")(EditEntry.as_view()), name="edit-entry"),
    url(r'^admin/ajax/upload-image/$', 'admin.ajax_upload_image', name="ajax-upload-image"),
    url(r'^admin/ajax/get-images/$', 'admin.ajax_get_images', name="ajax-get-images"),
    url(r'^admin/ajax/delete-image/$', 'admin.ajax_delete_image', name="ajax-delete-image"),
